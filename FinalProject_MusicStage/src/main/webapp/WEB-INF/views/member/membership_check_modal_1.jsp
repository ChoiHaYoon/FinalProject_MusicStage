...
<body>
    ...
    <div class="modal-bg2">
        <div class="modal2">
            <form id="interest_frm" action="join4.me" accept-charset="UTF-8" method="post" style="display: inline; margin: 0 auto;">
	        	<div class="headpoint">
    ...
    <script>
        ...
        $(".img_div").on("click", function(event){
        	...
        	if(list_length <= 3 && list.indexOf(origin_like_interest) == -1){
        		count++;
        		...
        		$("#four").css("color", "red");
        	} else if(list.indexOf(origin_like_interest) >= 0){
        		count--;
