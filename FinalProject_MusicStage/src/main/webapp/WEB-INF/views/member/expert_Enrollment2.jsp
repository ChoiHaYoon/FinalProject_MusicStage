...
<body>
		<div id="content_frame" style="display: block;">
				<!--  전문 분야  시작 -->	
			<form action="expert.fo" method="POST" enctype="multipart/form-data" >
			...
			<div style=" display: inline-block;">
				...
				<div>
					...
					<div style="line-height: 15px;" id="school" >
						...
						<input id="textgg"; required="required" value="" type="text" name="major" style=" width:500px; height:30px; border-color: #e4e5ed;  margin-top: 20px; border-radius: 8px; border-style: solid; border-width: 1px; display: inline-block; border-color: e4e5ed;">
...
<!-- 				<input type="file" value="" style="display: none;" id="asdf"> -->
			...
			<div style="  margin-top: 20px; ">
				...
				<textarea name="certification" required="required" style="display:inline-block; width:500px; height:150px; border-color: #e4e5ed;  margin-top: 20px; border-radius: 8px; border-style: solid; border-width: 1px;  resize: none;" rows="5" cols="33"></textarea>
				</div>
				<div id="gggg2">
				...
				<div  style=" height:30px; margin-top: 10px; margin-bottom: 20px; z-index: 400;">
					<span style="width:580px; height:50px; position:absolute;  font-weight: bolder; display: inline-block;">하위카테고리
										...
										<input type="text" placeholder="필요한 카테고리를 입력해주세요"   name="middle_special_category" class="gg" id="first2" style="position: absolute; z-index: 400; height:30px; width:500px;  display: inline-block; text-align: center;">
				</div>
						
				<!--  카테고리 분야  부분 끝 -->	
				
				<!--  서비스타입 분야  시작 -->	
					<input type="hidden" name="service_type" id="service_type" style="display: none;">
				...
				<input type="hidden"  required="required" name="form_of_provision" id="form_of_provision" style="display: none;">
		...
		<input type="hidden"  required="required" name="additional_options" id="additional_options" style="display: none;">
			<input type="checkbox" id="check5" style="display: none; z-index: 100;">
				...
				<div style="width: auto; height: auto; text-align: center;  margin-top: 50px; margin-bottom: 50px;">
							<input type="button" value="등록" id="next" class="button_css" style="display: inline-block;">
