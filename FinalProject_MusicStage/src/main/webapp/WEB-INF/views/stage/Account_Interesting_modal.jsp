		       			...
		       			<c:if test="{i%j == 0}">
		       				...
		       				<td class="table_img_frame">
		       					<c:if test="${fn:indexOf(list.like_interest_name, '/') == -1 }">
		       						<div class="img_div" id="img_div${status.count}	" style="background-image:url(<%= request.getContextPath() %>/resources/images/member_interesting/${list.like_interest_name}.jpeg); background-size:cover" value="${list.like_interest}">
		       					...
		       					<c:if test="${fn:indexOf(list.like_interest_name, '/') != -1 }">
		       						<div class="img_div" id="img_div${status.count}	" style="background-image:url(<%= request.getContextPath() %>/resources/images/member_interesting/${fn:replace(list.like_interest_name, '/', ',')}.jpeg); background-size:cover" value="${list.like_interest}">
		       							<div class="hover_name">
		       								<p><c:out value="${list.like_interest_name}"/></p>
		       							</div>
		       						</div>
